...
const Router = createBrowserRouter([
    ...
    { path:'/admindashboard/:userId', element:<AdminDashboard/>},
    { path: '/verificationmessage', element: <VerificationMessage /> }, 
    {path: '/artisandashboard/:userId', element: <ArtisanDashoard/>},
    { path: '/employerdashboard/:userId', element: <EmployerDash/> },
